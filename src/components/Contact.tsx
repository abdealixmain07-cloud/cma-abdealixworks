              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3.5 rounded-lg border border-input bg-secondary text-sm text-foreground focus:outline-none transition-all duration-200"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-5 py-3.5 rounded-lg border border-input bg-secondary text-sm text-foreground focus:outline-none resize-none transition-all duration-200"
                ...
                <button
                  type="submit"
                  className="w-full bg-foreground text-background py-4 rounded-lg text-sm font-medium transition-all duration-200 hover:shadow-lg flex items-center justify-center gap-2"
                >
